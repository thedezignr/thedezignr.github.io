      ...
      <section className={style.main__container}>
        <section>
          <main className="main__body">
            ...
            <img onLoad={e => e.target.classList.remove("image__loader")} className={`${style.major__image} ${style.loan__up__survey__data} image__loader`} src={loan_up_survey_data} alt="A screenshot of the responses of the users." />
            ...
            <img onLoad={e => e.target.classList.remove("image__loader")} className={`${style.major__image__1} ${style.loan__up__user__persona} image__loader`} src={loan_up_user_persona} alt="This is a goal-oriented user persona used for this project." />
            ...
            <div className={style.double__image}>
              <div>
                <img onLoad={e => e.target.classList.remove("image__loader")} className={`${style.major__image} ${style.loan__up__wireflow} image__loader`} src={loan_up_wire_flow} alt="LoanUp wireflow" />
                <h4 className={style.alt__text}>LoanUp wireflow</h4>
              </div>
              <div>
                <img onLoad={e => e.target.classList.remove("image__loader")} className={`${style.minor__image} ${style.loan__up__wire__frame} image__loader`} src={loan_up_wire_frame} alt="LoanUp Wireframes" />
            ...
            <img onLoad={e => e.target.classList.remove("image__loader")} className={`${style.major__image} ${style.loan__up__screens} image__loader`} src={loan_up_screens} alt="LoanUp Screens" />
